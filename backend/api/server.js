...
import { performerRoute } from './route/performerRoute.js'
...
app.use('/api/performers', authMiddleware, performerRoute)
...
const startServer = async () => {
  try {
    ...
    app.listen(PORT, () => {
      ...
      console.log(`   - Performers: http://localhost:${PORT}/api/performers/*`);
