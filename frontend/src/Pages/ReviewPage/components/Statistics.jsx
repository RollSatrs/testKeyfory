  ...
  if (loading) {
    return (
      <div className="p-4 grid grid-cols-4 gap-4">
        {[1, 2, 3, 4].map((item) => (
          <div key={item} className="bg-white rounded-4xl shadow p-6 flex flex-col animate-pulse">
    ...
    <div className="p-4 grid grid-cols-4 gap-4">
      <div className="bg-white rounded-4xl shadow p-6 flex flex-col">
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <span className="text-xl font-bold">{currentStats.totalServices}</span>
        </div>
      ...
      <div className="bg-white rounded-4xl shadow p-6 flex flex-col">
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <span className="text-xl font-bold">{currentStats.totalExecuters}</span>
        </div>
        <span className="text-green-500 text-xs mt-1">
      ...
      <div className="bg-white rounded-4xl shadow p-6 flex flex-col">
        ...
        <span className={`text-xs mt-1 ${currentStats.revenueGrowth >= 0 ? 'text-green-500' : 'text-red-500'}`}>
